...
--   Date and Time:   22:09 Thursday December 28, 2017
--   Exported By:     ADBMS
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,4874424041099643));
...
wwv_flow_api.create_flow(
  ...
  p_owner => nvl(wwv_flow_application_install.get_schema,'ADBMS'),
  ...
  p_default_page_template=> 833775339987120822 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 833775941310120824 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 833783041333120848 + wwv_flow_api.g_id_offset,
  p_error_template=> 833775339987120822 + wwv_flow_api.g_id_offset,
  p_checksum_salt_last_reset => '20171228220904',
  ...
  p_cust_authentication_process=> '.'||to_char(792366459483850377 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 4,
  p_default_label_template => 833793647080120892 + wwv_flow_api.g_id_offset,
  p_default_report_template => 833791853923120886 + wwv_flow_api.g_id_offset,
  p_default_list_template => 833788955844120872 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 833793924941120892 + wwv_flow_api.g_id_offset,
  p_default_button_template => 833777440866120829 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 833780052719120838 + wwv_flow_api.g_id_offset,
  p_default_form_template => 833780332213120840 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 833785052594120856 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 833783041333120848 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>833783041333120848 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 833778827897120834 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 833779732719120837 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 833781838324120844 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADBMS',
  p_last_upd_yyyymmddhh24miss=> '20171228220904',
...
wwv_flow_api.create_security_scheme(
  p_id => 791503180843880380 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_security_scheme(
  p_id => 792306555881414154 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
...
wwv_flow_api.create_security_scheme(
  p_id => 819391774410513925 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_name=>'Admin Users',
  p_scheme_type=>'EXISTS',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 790920366583282206 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_icon_sequence=> 10,
  p_icon_image => '',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 834307928614461766 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_icon_sequence=> 10,
  p_icon_image => '',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 790920265119282205 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_icon_sequence=> 20,
  p_icon_image => '',
...
wwv_flow_api.create_flow_item(
  p_id=> 790920851906282361 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_flow_item(
  p_id=> 821146866840884829 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'G_PAGE_INFO',
  p_data_type=> 'VARCHAR',
  p_is_persistent=> 'Y',
...
wwv_flow_api.create_tab (
  p_id=> 790919781151282199 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 1,
  p_tab_name=> 'T_HOME',
...
wwv_flow_api.create_tab (
  p_id=> 790919861987282203 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 2,
...
wwv_flow_api.create_tab (
  p_id=> 790919981162282204 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 3,
...
wwv_flow_api.create_tab (
  p_id=> 790920055229282204 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 4,
  p_tab_name=> 'T_ORDERS',
...
wwv_flow_api.create_tab (
  p_id=> 790920161445282205 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 5,
  p_tab_name=> 'T_CHARTS',
...
wwv_flow_api.create_tab (
  p_id=> 819448079407676166 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 15,
  p_tab_name=> 'T_ADMIN',
  ...
  p_tab_parent_tabset=>'',
  p_security_scheme => 819391774410513925+ wwv_flow_api.g_id_offset,
  p_tab_comment  => '');
...
wwv_flow_api.create_list_of_values (
  p_id       => 791845056170642707 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'CATEGORIES',
  p_lov_query=> '.'||to_char(791845056170642707 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>791845373843642710 + wwv_flow_api.g_id_offset,
  p_lov_id=>791845056170642707 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>791845575318642712 + wwv_flow_api.g_id_offset,
  p_lov_id=>791845056170642707 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>791845750471642712 + wwv_flow_api.g_id_offset,
  p_lov_id=>791845056170642707 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_list_of_values (
  p_id       => 793129349288137308 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'PRODUCTS',
...
wwv_flow_api.create_list_of_values (
  p_id       => 815993577958214950 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
...
wwv_flow_api.create_list_of_values (
  p_id       => 792396850190100662 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'STATES',
...
wwv_flow_api.create_list_of_values (
  p_id       => 791498174132869045 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'Y OR N',
  p_lov_query=> '.'||to_char(791498174132869045 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>791498465152869048 + wwv_flow_api.g_id_offset,
  p_lov_id=>791498174132869045 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>791498674873869050 + wwv_flow_api.g_id_offset,
  p_lov_id=>791498174132869045 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>2,
  p_lov_disp_value=>'No',
...
wwv_flow_api.create_page_plug (
  p_id=> 791181257605870662 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 0,
  p_plug_name=> 'Menu',
  p_region_name=>'',
  p_plug_template=> 833778827897120834+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(791178066478863823 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 833793924941120892+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 791589661535206015 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 0,
  p_plug_name=> 'Reports',
  p_region_name=>'',
  p_plug_template=> 833780924153120841+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_03',
  p_plug_source=> s,
  p_plug_source_type=> 819412862991586279 + wwv_flow_api.g_id_offset,
  p_translate_title=> 'Y',
  p_plug_display_error_message=> '#SQLERRM#',
  p_plug_query_row_template=> 1,
...
wwv_flow_api.create_page_plug (
  p_id=> 829325676147621738 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Sample Application',
  p_region_name=>'',
  p_plug_template=> 833783956018120851+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_plug (
  p_id=> 829332450436633256 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Tasks',
  p_region_name=>'',
  p_plug_template=> 833784233675120852+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 60,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_03',
  p_plug_source=> s,
  p_plug_source_type=> 791290772805272506 + wwv_flow_api.g_id_offset,
  p_translate_title=> 'Y',
  p_plug_display_error_message=> '#SQLERRM#',
  p_plug_query_row_template=> 1,
  p_plug_query_headings_type=> 'COLON_DELMITED_LIST',
...
wwv_flow_api.create_report_region (
  p_id=> 830874148169657796 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_name=> 'Top Customers',
  p_region_name=>'',
  p_template=> 833783041333120848+ wwv_flow_api.g_id_offset,
  ...
  p_ajax_enabled=> 'Y',
  p_rest_enabled=> 'N',
  p_query_row_template=> 833792845277120889+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_report_columns (
  p_id=> 830875825013679433 + wwv_flow_api.g_id_offset,
  p_region_id=> 830874148169657796 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 830874640083657862 + wwv_flow_api.g_id_offset,
  p_region_id=> 830874148169657796 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 830875952217679434 + wwv_flow_api.g_id_offset,
  p_region_id=> 830874148169657796 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
wwv_flow_api.create_report_region (
  p_id=> 830876236918692397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_name=> 'Top Products',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 830876843845694383 + wwv_flow_api.g_id_offset,
  p_region_id=> 830876236918692397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 830876952852694383 + wwv_flow_api.g_id_offset,
  p_region_id=> 830876236918692397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 833897956289041340 + wwv_flow_api.g_id_offset,
  p_region_id=> 830876236918692397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_plug (
  p_id=> 833704444927817689 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Sales Quota',
  p_region_name=>'',
  p_region_attributes=> ' style="width:49%; float:left; margin-right: 1%;"',
  p_plug_template=> 833783041333120848+ wwv_flow_api.g_id_offset,
  ...
  p_plug_query_headings_type=> 'COLON_DELMITED_LIST',
  p_plug_query_row_count_max => 500,
  p_plug_required_role => '!'||(819391774410513925+ wwv_flow_api.g_id_offset),
  p_plug_display_condition_type => '',
...
wwv_flow_api.create_flash_chart5(
  p_id => 833704641970817695+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 1,
  p_region_id => 833704444927817689+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flash_chart5_series(
  p_id => 833704751738817706+wwv_flow_api.g_id_offset,
  p_chart_id => 833704641970817695+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_series_seq                =>10,
...
wwv_flow_api.create_report_region (
  p_id=> 833705037785825035 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 833705335577825049 + wwv_flow_api.g_id_offset,
  p_region_id=> 833705037785825035 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
  p_column_alias=> 'SALES',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 833898338412045701 + wwv_flow_api.g_id_offset,
  p_region_id=> 833705037785825035 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 834021124381070730 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Sales Quota',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 830877740990712462 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
  p_button_sequence=> 10,
  p_button_plug_id => 830874148169657796+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 833719043486063240 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
  p_button_sequence=> 20,
  p_button_plug_id => 830876236918692397+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 833716147033045308 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
  p_button_sequence=> 30,
  p_button_plug_id => 833705037785825035+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_plug (
  p_id=> 647063179352992945 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Customers',
  p_region_name=>'',
  p_plug_template=> 833781838324120844+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
wwv_flow_api.create_worksheet(
  p_id=> 647063280235992945+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_region_id=> 647063179352992945+wwv_flow_api.g_id_offset,
  p_name=> 'Customers',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
wwv_flow_api.create_worksheet_column(
  p_id => 647063465217992945+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 647063280235992945+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 647063570010992946+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 647063280235992945+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 647063658649992946+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 647063280235992945+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 647063776194992946+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 647063280235992945+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 647063878624992946+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 647063280235992945+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 647063956173992946+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 647063280235992945+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 501015948011035408+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 647063280235992945+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_button(
  p_id             => 647066062571001489 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
  p_button_sequence=> 10,
  p_button_plug_id => 647063179352992945+wwv_flow_api.g_id_offset,
  p_button_name    => 'NEW',
  p_button_image   => 'template:'||to_char(833777440866120829+wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_branch(
  p_id=>830265038251363753 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
...
wwv_flow_api.create_page_branch(
  p_id=>923087379404712489 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_branch_action=> 'f?p=&APP_ID.:7:&SESSION.::&DEBUG.:7:P7_BRANCH:2',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>647066062571001489+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'Y',
  p_branch_comment=> '');
 
wwv_flow_api.create_page_branch(
  p_id=>923070983438665019 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
...
wwv_flow_api.create_page_process(
  p_id     => 830264552696363750 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 2,
  ...
  p_process_when_button_id=>830263035763363741 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 830264741954363751 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 2,
...
wwv_flow_api.create_page_plug (
  p_id=> 667331170226349272 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
...
wwv_flow_api.create_worksheet(
  p_id=> 667331255015349272+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_region_id=> 667331170226349272+wwv_flow_api.g_id_offset,
  p_name=> 'Products',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 667331478047349273+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 667331560437349273+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 667331653027349273+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 667331778285349273+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 667331880113349274+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 667331957553349274+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 667332073140349274+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 667332159110349274+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 667332256746349274+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 667332363453349274+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 697673541898266310+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 825276941375104727+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 825277035856104734+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 833892246151981708+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 667332559498350027+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 667331255015349272+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_report_region (
  p_id=> 966698277373137253 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_name=> 'Top 5 Products',
  p_region_name=>'',
  p_template=> 833784233675120852+ wwv_flow_api.g_id_offset,
  ...
  p_ajax_enabled=> 'N',
  p_rest_enabled=> 'N',
  p_query_row_template=> 833790830612120881+ wwv_flow_api.g_id_offset,
  p_query_headings_type=> 'NO_HEADINGS',
  p_query_num_rows=> '5',
  p_query_options=> 'DERIVED_REPORT_COLUMNS',
  p_query_break_cols=> '0',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 966698562279137261 + wwv_flow_api.g_id_offset,
  p_region_id=> 966698277373137253 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 966698653052137261 + wwv_flow_api.g_id_offset,
  p_region_id=> 966698277373137253 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_button(
  p_id             => 966891952204038331 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
  p_button_sequence=> 10,
  p_button_plug_id => 667331170226349272+wwv_flow_api.g_id_offset,
  ...
  p_button_execute_validations=>'Y',
  p_security_scheme => 791503180843880380+ wwv_flow_api.g_id_offset,
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  p_id=>966892168039038333 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
  p_branch_action=> 'f?p=&FLOW_ID.:6:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>966891952204038331+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'Y',
  p_branch_comment=> '');
...
wwv_flow_api.create_page_plug (
  p_id=> 825381345009574149 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Orders',
  p_region_name=>'',
...
wwv_flow_api.create_worksheet(
  p_id=> 825381447629574149+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_region_id=> 825381345009574149+wwv_flow_api.g_id_offset,
  p_name=> 'My Orders',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 825381852704574231+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 830288951701621193+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 830289044306621194+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 827898325065257228+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CUSTOMER_NAME',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 827898245613257228+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 827898426505257229+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 825381946081574231+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 825382353718574699+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 833901633141138764+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_worksheet_condition(
  p_id => 833903530034213565+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
  p_report_id => 833901633141138764+wwv_flow_api.g_id_offset,
  p_name                    =>'Orders <= $900',
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 833903645793213565+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
  p_report_id => 833901633141138764+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_group_by(
  p_id => 833903735509213565+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
  p_report_id => 833901633141138764+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 830290856297679298+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
begin
wwv_flow_api.create_worksheet_group_by(
  p_id => 833903936960215560+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 825381447629574149+wwv_flow_api.g_id_offset,
  p_report_id => 830290856297679298+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 794595955335906245 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 10,
  p_button_plug_id => 825381345009574149+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>794596153697906272 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_branch_action=> 'f?p=&APP_ID.:11:&SESSION.::&DEBUG.:11::&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>794595955335906245+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 5,
  p_save_state_before_branch_yn=>'Y',
  p_branch_comment=> '');
 
wwv_flow_api.create_page_branch(
  p_id=>792333474003539521 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
...
wwv_flow_api.create_page_process(
  p_id     => 792332954238539516 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_when_button_id=>792332864999539512 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 792333157067539518 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Error changing calendar date.',
  p_process_when_button_id=>792333061664539517 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 792333369255539518 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Error changing calendar date.',
  p_process_when_button_id=>792333266130539518 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_plug (
  p_id=> 827904044449370255 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Sales by Category / Month',
  p_region_name=>'',
  p_plug_template=> 833780052719120838+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'BEFORE_SHOW_ITEMS',
  p_plug_source=> s,
...
a1 := null;
wwv_flow_api.create_flash_chart5(
  p_id => 827904255456370256+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 5,
  p_region_id => 827904044449370255+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flash_chart5_series(
  p_id => 827904331081370261+wwv_flow_api.g_id_offset,
  p_chart_id => 827904255456370256+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_series_seq                =>10,
  p_series_name               =>'Sales',
  p_series_query              => a1,
...
wwv_flow_api.create_page (
 ...
 ,p_javascript_code => 
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
 ,p_required_role => 791503180843880380 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_cache_timeout_seconds => 21600
 ,p_cache_by_user_yn => 'N'
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 667535581165545520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 966689660142113364 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_plug_name=> 'Product Details',
  p_region_name=>'',
  p_plug_template=> 833780332213120840+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'BEFORE_SHOW_ITEMS',
  p_plug_source=> s,
...
wwv_flow_api.create_page_button(
  p_id             => 667584177936036562 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
  p_button_sequence=> 50,
  p_button_plug_id => 667535581165545520+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 966689957353113368 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
  p_button_sequence=> 30,
  p_button_plug_id => 966689660142113364+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image   => 'template:'||to_char(833777645071120830+wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_button(
  p_id             => 966690153919113370 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
  p_button_sequence=> 10,
  p_button_plug_id => 966689660142113364+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 966689864049113367 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
...
wwv_flow_api.create_page_button(
  p_id             => 966690057886113368 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
  p_button_sequence=> 20,
  p_button_plug_id => 966689660142113364+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>966690251885113373 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
...
wwv_flow_api.create_page_item(
  p_id=>667535058393520058 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  ...
  p_item_sequence=> 70,
  p_item_plug_id => 966689660142113364+wwv_flow_api.g_id_offset,
  ...
  p_field_template=> 833793647080120892+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
...
begin
wwv_flow_api.create_page_item(
  p_id=>667535379303535547 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_IMAGE',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 80,
  p_item_plug_id => 667535581165545520+wwv_flow_api.g_id_offset,
  ...
  p_field_template=> 667019673214656884+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>966690368683113376 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
...
wwv_flow_api.create_page_item(
  p_id=>966690472199113387 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  ...
  p_label_alignment=> 'RIGHT',
  p_field_alignment=> 'LEFT',
  p_field_template=> 833793847258120892+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_lov_display_extra=>'YES',
  p_protection_level => 'N',
  p_escape_on_http_output => 'Y',
...
wwv_flow_api.create_page_item(
  p_id=>966690684105113390 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
...
wwv_flow_api.create_page_item(
  p_id=>966690755989113390 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_CATEGORY',
  p_data_type=> 'VARCHAR',
  ...
  p_lov=> '.'||to_char(791845056170642707 + wwv_flow_api.g_id_offset)||'.',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 31,
  p_cMaxlength=> 255,
...
wwv_flow_api.create_page_item(
  p_id=>966690975682113390 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  ...
  p_named_lov=> 'Y OR N',
  p_lov=> '.'||to_char(791498174132869045 + wwv_flow_api.g_id_offset)||'.',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 2,
  p_cMaxlength=> 255,
...
wwv_flow_api.create_page_item(
  p_id=>966691054492113391 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
...
wwv_flow_api.create_page_process(
  p_id     => 966691161107113394 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 6,
  p_process_sequence=> 10,
...
wwv_flow_api.create_page_process(
  p_id     => 667584360190050354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 6,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_when_button_id=>667584177936036562 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 966691281184113395 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 6,
...
wwv_flow_api.create_page_process(
  p_id     => 966691355223113396 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 6,
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>966690057886113368 + wwv_flow_api.g_id_offset,
  p_process_when=>'DELETE_IMAGE',
  p_process_when_type=>'REQUEST_NOT_EQUAL_CONDITION',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 791243764578251237 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
...
wwv_flow_api.create_report_region (
  p_id=> 816310750259733274 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  ...
  p_translate_title=> 'Y',
  p_rest_enabled=> 'N',
  p_query_row_template=> 833791853923120886+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 816314857924763915 + wwv_flow_api.g_id_offset,
  p_region_id=> 816310750259733274 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'EDIT',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 816325257325820526 + wwv_flow_api.g_id_offset,
  p_region_id=> 816310750259733274 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 816324054599814669 + wwv_flow_api.g_id_offset,
  p_region_id=> 816310750259733274 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 816324152511814669 + wwv_flow_api.g_id_offset,
  p_region_id=> 816310750259733274 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 816326174425834944 + wwv_flow_api.g_id_offset,
  p_region_id=> 816310750259733274 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 816335579844902751 + wwv_flow_api.g_id_offset,
  p_region_id=> 816310750259733274 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 816335661426902752 + wwv_flow_api.g_id_offset,
  p_region_id=> 816310750259733274 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_plug (
  p_id=> 833861336202685504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
...
wwv_flow_api.create_page_button(
  p_id             => 791244075330251239 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  p_button_sequence=> 50,
  p_button_plug_id => 791243764578251237+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image   => 'template:'||to_char(833777645071120830+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Apply Changes',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
...
wwv_flow_api.create_page_button(
  p_id             => 791244260150251241 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  p_button_sequence=> 10,
  p_button_plug_id => 791243764578251237+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 791243954014251239 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
...
wwv_flow_api.create_page_button(
  p_id             => 791244159649251239 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  p_button_sequence=> 20,
  p_button_plug_id => 791243764578251237+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>808201558050016207 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
begin
wwv_flow_api.create_page_item(
  p_id=>791244580498251248 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 791243764578251237+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
...
wwv_flow_api.create_page_item(
  p_id=>791244674089251255 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
wwv_flow_api.create_page_item(
  p_id=>791244877255251259 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
wwv_flow_api.create_page_item(
  p_id=>791245062460251260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
wwv_flow_api.create_page_item(
  p_id=>791245152359251260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
wwv_flow_api.create_page_item(
  p_id=>791245272705251260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_CUST_CITY',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>791245371322251260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
wwv_flow_api.create_page_item(
  p_id=>791245468324251276 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
wwv_flow_api.create_page_item(
  p_id=>791245554346251276 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
wwv_flow_api.create_page_item(
  p_id=>791245677990251276 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
wwv_flow_api.create_page_item(
  p_id=>791245776417251276 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
wwv_flow_api.create_page_item(
  p_id=>791245850915251277 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
begin
wwv_flow_api.create_page_item(
  p_id=>808188659949978904 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_BRANCH',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_validation(
  p_id => 792504474626198419 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  ...
  p_associated_item=> 791245554346251276 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 792507058135203106 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  ...
  p_validation_type => 'REGULAR_EXPRESSION',
  p_error_message => 'Phone number format not recognized',
  p_associated_item=> 791245677990251276 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 769876980235702613 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 833902325700174438 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
...
'end;',
  ...
  p_always_execute=>'N',
  p_when_button_pressed=> 791244159649251239 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 791245977307251280 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 7,
...
wwv_flow_api.create_page_process(
  p_id     => 791246056497251282 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 791246161172251282 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>791244159649251239 + wwv_flow_api.g_id_offset,
  p_process_when=>'',
...
wwv_flow_api.create_page (
 ...
 ,p_javascript_code => 
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
 ,p_required_role => 819391774410513925 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_last_updated_by => 'SBKENNED'
...
wwv_flow_api.create_report_region (
  p_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_name=> 'Manage Users',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 791407059242509281 + wwv_flow_api.g_id_offset,
  p_region_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 791405954667509248 + wwv_flow_api.g_id_offset,
  p_region_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 791406056523509250 + wwv_flow_api.g_id_offset,
  p_region_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 791406256952509251 + wwv_flow_api.g_id_offset,
  p_region_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 791406371729509251 + wwv_flow_api.g_id_offset,
  p_region_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 791415371785532334 + wwv_flow_api.g_id_offset,
  p_region_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 791495975023861830 + wwv_flow_api.g_id_offset,
  p_region_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
  ...
  p_named_lov=>791498174132869045 + wwv_flow_api.g_id_offset,
  p_lov_show_nulls=> 'NO',
  p_is_required=> false,
  p_attribute_01=> '2',
  p_pk_col_source=> s,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 792246655069034969 + wwv_flow_api.g_id_offset,
  p_region_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 819387253118505687 + wwv_flow_api.g_id_offset,
  p_region_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_button(
  p_id             => 791406780687509257 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 40,
  p_button_plug_id => 791405773310509239+wwv_flow_api.g_id_offset,
  p_button_name    => 'ADD',
  p_button_image   => 'template:'||to_char(833777840839120830+wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_button(
  p_id             => 791406571347509257 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 30,
  p_button_plug_id => 791405773310509239+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 791406459353509257 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 10,
  p_button_plug_id => 791405773310509239+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 791406666372509257 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 20,
  p_button_plug_id => 791405773310509239+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>791407375910509282 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
...
wwv_flow_api.create_page_validation(
  p_id => 830321448949121809 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_tabular_form_region_id => 791405773310509239 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 830571437839241559 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_tabular_form_region_id => 791405773310509239 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 830572236847269702 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_tabular_form_region_id => 791405773310509239 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 830571054677236992 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_tabular_form_region_id => 791405773310509239 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 791406852121509278 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process update',
  p_process_when_button_id=>791406571347509257 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '#MRU_COUNT# row(s) updated, #MRI_COUNT# row(s) inserted.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 791406969186509279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 791407160606509282 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process update',
  p_process_when_button_id=>791406780687509257 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '#MRU_COUNT# row(s) updated, #MRI_COUNT# row(s) inserted.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 791407258236509282 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 791414855003532329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 1,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 791414970385532329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 2,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 791415072937532329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 3,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 791415173952532329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 4,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 791415272821532329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 5,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 791495857828861823 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 6,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 792246572946034932 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 7,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 819387164099505678 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 791405773310509239 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 8,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 791444060122628390 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
...
wwv_flow_api.create_page_plug (
  p_id=> 792421372175270360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_plug_name=> 'Error!',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 792407578746196632 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 5,
  p_button_plug_id => 791444060122628390+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_image   => 'template:'||to_char(833777440866120829+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Cancel',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
...
wwv_flow_api.create_page_button(
  p_id             => 791515654917901286 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 10,
  p_button_plug_id => 791444060122628390+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>791515861030901299 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_branch_action=> 'f?p=&APP_ID.:8:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>791515654917901286+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'Y',
  p_branch_comment=> '');
 
wwv_flow_api.create_page_branch(
  p_id=>792407772748196641 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_branch_action=> 'f?p=&APP_ID.:8:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'BEFORE_COMPUTATION',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>792407578746196632+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'Y',
  p_branch_comment=> '');
...
begin
wwv_flow_api.create_page_item(
  p_id=>791444763585629399 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_name=>'P9_USER_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 791444060122628390+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_HIDDEN',
...
wwv_flow_api.create_page_item(
  p_id=>791513069677896154 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_name=>'P9_NEW_PW',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>791513874872897560 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_name=>'P9_NEW_PW_2',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>791519580197908644 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_name=>'P9_USER_NAME',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_validation(
  p_id => 791526979421927300 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
...
'end;',
  ...
  p_associated_item=> 791513069677896154 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_IN_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_process(
  p_id     => 792375657021897030 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_calendar (
  p_id=> 827791427818939756 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 10,
  ...
  p_plug_template=> 833783341964120849+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column  => 1,
  p_plug_display_point   => 'AFTER_SHOW_ITEMS',
  ...
  p_rest_enabled=>'',
  p_plug_comment=> '',
  p_cal_id=>827791633817939762 + wwv_flow_api.g_id_offset,
  p_start_date=>'',
  p_end_date=>'',
  ...
  p_calendar_type=>'A',
  p_template_id=>833794141677120892 + wwv_flow_api.g_id_offset,
  p_calendar_comments=>'');
end;
/
...
wwv_flow_api.create_page_button(
  p_id             => 827791830083939763 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 50,
  p_button_plug_id => 827791427818939756+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 827792039649939764 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
...
wwv_flow_api.create_page_button(
  p_id             => 827792234505939765 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
...
begin
wwv_flow_api.create_page_item(
  p_id=>827792443168939766 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
  p_item_plug_id => 827791427818939756+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>827792633209939772 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
...
begin
wwv_flow_api.create_page_item(
  p_id=>827792834721939774 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
...
wwv_flow_api.create_page (
 ...
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'ON'
 ,p_step_template => 833774434270120820 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_cache_timeout_seconds => 21600
 ,p_cache_by_user_yn => 'N'
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 808150864956866767 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 11,
  p_plug_name=> 'Identify Customer',
  p_region_name=>'',
  p_plug_template=> 833785052594120856+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 808153556083873713 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 11,
  ...
  p_plug_source=> s,
  p_plug_source_type=> 808152074653869632 + wwv_flow_api.g_id_offset,
  p_translate_title=> 'Y',
  p_plug_display_error_message=> '#SQLERRM#',
  p_plug_query_row_template=> 1,
  p_plug_query_headings_type=> 'QUERY_COLUMNS',
...
wwv_flow_api.create_page_button(
  p_id             => 816302460816698528 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 11,
  p_button_sequence=> 10,
  p_button_plug_id => 808150864956866767+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_image   => 'template:'||to_char(833777440866120829+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Cancel',
  p_button_position=> 'REGION_TEMPLATE_CLOSE',
...
wwv_flow_api.create_page_button(
  p_id             => 808160474700898057 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 11,
  p_button_sequence=> 30,
  p_button_plug_id => 808150864956866767+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>808160655444898064 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11,
  p_branch_action=> 'f?p=&APP_ID.:12:&SESSION.::&DEBUG.:RP,12:P12_BRANCH:11&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>808160474700898057+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
...
wwv_flow_api.create_page_branch(
  p_id=>808163469450906688 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11,
...
wwv_flow_api.create_page_branch(
  p_id=>816302675821698531 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11,
  p_branch_action=> 'f?p=&FLOW_ID.:4:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>816302460816698528+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'Y',
  p_branch_comment=> '');
...
wwv_flow_api.create_page_item(
  p_id=>808158555306892386 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 808150864956866767+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Customer',
  p_source_type=> 'STATIC',
...
wwv_flow_api.create_page_item(
  p_id=>833822225973219026 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11,
...
wwv_flow_api.create_page_validation(
  p_id => 833833135117306805 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 11,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  ...
  p_when_button_pressed=> 808160474700898057 + wwv_flow_api.g_id_offset,
  p_associated_item=> 808158555306892386 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_da_event (
  p_id => 833829255156284159 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_page_id => 11
...
wwv_flow_api.create_page_da_action (
  p_id => 833829551507284160 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_page_id => 11
 ,p_event_id => 833829255156284159 + wwv_flow_api.g_id_offset
 ,p_event_result => 'TRUE'
...
wwv_flow_api.create_page_da_action (
  p_id => 833829727251284161 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_page_id => 11
 ,p_event_id => 833829255156284159 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_process(
  p_id     => 816078981419916157 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 11,
  p_process_sequence=> 10,
...
'};'
 ,p_step_template => 833774742384120820 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_cache_timeout_seconds => 21600
 ,p_cache_by_user_yn => 'N'
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 816054779847802154 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 12,
  p_plug_name=> 'Order Progress',
  p_region_name=>'',
...
wwv_flow_api.create_page_plug (
  p_id=> 834007041490810779 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 12,
...
wwv_flow_api.create_page_button(
  p_id             => 816238158740347857 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 12,
  p_button_sequence=> 10,
  p_button_plug_id => 834007041490810779+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_image   => 'template:'||to_char(833777440866120829+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Cancel',
  p_button_position=> 'REGION_TEMPLATE_CLOSE',
...
wwv_flow_api.create_page_button(
  p_id             => 816129476646170205 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 12,
  p_button_sequence=> 20,
  p_button_plug_id => 834007041490810779+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 833831938795298356 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 12,
  p_button_sequence=> 30,
  p_button_plug_id => 834007041490810779+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>816129662189170216 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 12,
  p_branch_action=> 'f?p=&FLOW_ID.:14:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>816129476646170205+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'Y',
  p_branch_comment=> '');
 
wwv_flow_api.create_page_branch(
  p_id=>816238378478347863 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 12,
  p_branch_action=> 'f?p=&FLOW_ID.:4:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>816238158740347857+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'Y',
  p_branch_comment=> '');
 
wwv_flow_api.create_page_branch(
  p_id=>833854627835579060 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 12,
  p_branch_action=> 'P12_BRANCH',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'BRANCH_TO_PAGE_IDENT_BY_ITEM',
  p_branch_when_button_id=>833831938795298356+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 20,
  p_save_state_before_branch_yn=>'Y',
...
begin
wwv_flow_api.create_page_item(
  p_id=>816058570197827685 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 12,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 816054779847802154+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_HIDDEN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>816122670928130749 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 12,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
  p_item_plug_id => 834007041490810779+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_HIDDEN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>833854243980574277 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 12,
  p_name=>'P12_BRANCH',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_computation(
  p_id=> 816061062363834896 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 12,
...
wwv_flow_api.create_page_process(
  p_id     => 816263560275509126 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 12,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>816129476646170205 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 816080178433924737 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 12,
  p_process_sequence=> 10,
  p_process_point=> 'BEFORE_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 816099666847034928 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 12,
  p_process_sequence=> 20,
  p_process_point=> 'BEFORE_HEADER',
...
wwv_flow_api.create_page_plug (
  p_id=> 834259237561795605 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
...
a1 := null;
wwv_flow_api.create_flash_chart5(
  p_id => 834259435731795608+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 13,
  p_region_id => 834259237561795605+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flash_chart5_series(
  p_id => 834259538567795610+wwv_flow_api.g_id_offset,
  p_chart_id => 834259435731795608+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_series_seq                =>10,
  p_series_name               =>'Series 1',
  p_series_query              => a1,
...
wwv_flow_api.create_page_plug (
  p_id=> 828503963512305850 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 14,
  p_plug_name=> 'Order Progress',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 833900446600114297 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 14,
...
wwv_flow_api.create_page_plug (
  p_id=> 828406164692041192 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 14,
  p_plug_name=> 'Order Header',
  p_region_name=>'',
  p_parent_plug_id=>833900446600114297 + wwv_flow_api.g_id_offset,
  p_plug_template=> 0,
  p_plug_display_sequence=> 20,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
...
wwv_flow_api.create_report_region (
  p_id=> 828421678469139763 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 14,
  p_name=> 'Order Lines',
  p_region_name=>'',
  p_parent_plug_id=>833900446600114297 + wwv_flow_api.g_id_offset,
  p_template=> 4874923673099776+ wwv_flow_api.g_id_offset,
  p_display_sequence=> 30,
  p_display_column=> 1,
  p_display_point=> 'AFTER_SHOW_ITEMS',
  p_source=> s,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 828423759684153341 + wwv_flow_api.g_id_offset,
  p_region_id=> 828421678469139763 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'PRODUCT_NAME',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 828422170730139785 + wwv_flow_api.g_id_offset,
  p_region_id=> 828421678469139763 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 828422261342139785 + wwv_flow_api.g_id_offset,
  p_region_id=> 828421678469139763 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 828423879848153342 + wwv_flow_api.g_id_offset,
  p_region_id=> 828421678469139763 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_button(
  p_id             => 830582849482585515 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 14,
  p_button_sequence=> 10,
  p_button_plug_id => 833900446600114297+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 833901054350125920 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 14,
  p_button_sequence=> 20,
  p_button_plug_id => 833900446600114297+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>828400975165025306 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 14,
  p_name=>'P14_ORDER_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 828421678469139763+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_HIDDEN',
...
wwv_flow_api.create_page_plug (
  p_id=> 819462867464710589 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
...
a1 := null;
wwv_flow_api.create_flash_chart5(
  p_id => 501618154470531281+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 16,
  p_region_id => 819462867464710589+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flash_chart5_series(
  p_id => 501618238926531282+wwv_flow_api.g_id_offset,
  p_chart_id => 501618154470531281+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_series_seq                =>10,
...
wwv_flow_api.create_page_plug (
  p_id=> 830216954268006955 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
...
a1 := null;
wwv_flow_api.create_flash_chart5(
  p_id => 830217125620006956+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 16,
  p_region_id => 830216954268006955+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flash_chart5_series(
  p_id => 830217228099006957+wwv_flow_api.g_id_offset,
  p_chart_id => 830217125620006956+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_series_seq                =>10,
  p_series_name               =>'Series 1',
  p_series_query              => a1,
...
wwv_flow_api.create_page_plug (
  p_id=> 829964336109840942 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 17,
...
a1 := null;
wwv_flow_api.create_flash_chart5(
  p_id => 829964556151840945+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 17,
  p_region_id => 829964336109840942+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flash_chart5_series(
  p_id => 829964625537840950+wwv_flow_api.g_id_offset,
  p_chart_id => 829964556151840945+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_series_seq                =>10,
  p_series_name               =>'Series 1',
  p_series_query              => a1,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 833876235716889329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 18,
  p_plug_name=> 'Customer Details',
  p_region_name=>'',
...
wwv_flow_api.create_page_plug (
  p_id=> 833884630212889379 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 18,
  p_plug_name=> 'New Customer',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 833884832893889380 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 18,
  p_plug_name=> 'Order Progress',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 833894940872999083 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 18,
  p_plug_name=> 'Order Progress',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 833877032068889338 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 18,
  p_button_sequence=> 50,
  p_button_plug_id => 833876235716889329+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 833877252578889340 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 18,
  p_button_sequence=> 10,
  p_button_plug_id => 833876235716889329+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 833877631088889342 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 18,
  p_button_sequence=> 20,
  p_button_plug_id => 833876235716889329+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>833890945889962733 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
  p_branch_action=> 'f?p=&APP_ID.:12:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>833877032068889338+ wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>833877846375889344 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 833876235716889329+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Customer ID',
  p_source=>'CUSTOMER_ID',
  p_source_type=> 'DB_COLUMN',
...
wwv_flow_api.create_page_item(
  p_id=>833878041646889347 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
...
wwv_flow_api.create_page_item(
  p_id=>833878552548889349 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
...
wwv_flow_api.create_page_item(
  p_id=>833879029463889351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
...
wwv_flow_api.create_page_item(
  p_id=>833879543978889353 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
...
wwv_flow_api.create_page_item(
  p_id=>833880030879889355 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
...
wwv_flow_api.create_page_item(
  p_id=>833880555219889357 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
...
wwv_flow_api.create_page_item(
  p_id=>833881036634889361 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
...
wwv_flow_api.create_page_item(
  p_id=>833881550102889363 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
...
wwv_flow_api.create_page_item(
  p_id=>833882047337889365 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
...
wwv_flow_api.create_page_item(
  p_id=>833882554638889367 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
...
begin
wwv_flow_api.create_page_item(
  p_id=>833883036600889369 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
  p_name=>'P18_BRANCH',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>833883225688889370 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
...
wwv_flow_api.create_page_validation(
  p_id => 833885547326889390 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 18,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  ...
  p_validation_type => 'REGULAR_EXPRESSION',
  p_error_message => 'Phone number format not recognized',
  p_associated_item=> 833881550102889363 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 833885731942889390 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 18,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  ...
  p_validation_type => 'REGULAR_EXPRESSION',
  p_error_message => 'Phone number format not recognized',
  p_associated_item=> 833882047337889365 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 833885355625889388 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 18,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'Credit Limit <= 5000',
...
wwv_flow_api.create_page_process(
  p_id     => 833885941116889391 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 18,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 833886146320889395 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 18,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 833886355058889396 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 18,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>833877631088889342 + wwv_flow_api.g_id_offset,
  p_process_when=>'',
  p_process_when_type=>'NEVER',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 834268128543923904 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 19,
...
wwv_flow_api.create_jstree(
  p_id => 834268323806923906+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 19,
  p_region_id => 834268128543923904+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 834268528057923916 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 19,
  p_button_sequence=> 10,
  p_button_plug_id => 834268128543923904+wwv_flow_api.g_id_offset,
  p_button_name    => 'CONTRACT_ALL',
  p_button_image   => 'template:'||to_char(833777440866120829+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Collapse All',
  p_button_position=> 'TOP',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'javascript:apex.widget.tree.collapse_all(''tree'||to_char(834268323806923906+wwv_flow_api.g_id_offset)||''');',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 834268744633923921 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 19,
  p_button_sequence=> 10,
  p_button_plug_id => 834268128543923904+wwv_flow_api.g_id_offset,
  ...
  p_button_position=> 'TOP',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'javascript:apex.widget.tree.expand_all(''tree'||to_char(834268323806923906+wwv_flow_api.g_id_offset)||''');',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page (
 ...
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'ON'
 ,p_step_template => 833775627326120823 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_cache_timeout_seconds => 21600
 ,p_cache_by_user_yn => 'N'
...
wwv_flow_api.create_report_region (
  p_id=> 991284076674730861 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 20,
  p_name=> 'Product Information',
  p_region_name=>'',
  p_template=> 833782139909120845+ wwv_flow_api.g_id_offset,
  p_display_sequence=> 10,
  p_display_column=> 2,
  p_display_point=> 'BEFORE_SHOW_ITEMS',
  p_source=> s,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 991284379609730886 + wwv_flow_api.g_id_offset,
  p_region_id=> 991284076674730861 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'PRODUCT_NAME',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 991284456120730886 + wwv_flow_api.g_id_offset,
  p_region_id=> 991284076674730861 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 991284554820730886 + wwv_flow_api.g_id_offset,
  p_region_id=> 991284076674730861 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 991284751890730886 + wwv_flow_api.g_id_offset,
  p_region_id=> 991284076674730861 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
wwv_flow_api.create_report_region (
  p_id=> 1001777353661231552 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 20,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 667590556623266928 + wwv_flow_api.g_id_offset,
  p_region_id=> 1001777353661231552 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_button(
  p_id             => 991298172313814738 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 20,
  p_button_sequence=> 10,
  p_button_plug_id => 991284076674730861+wwv_flow_api.g_id_offset,
  p_button_name    => 'CLOSE',
...
begin
wwv_flow_api.create_page_item(
  p_id=>991285683947732936 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 20,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 991284076674730861+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_HIDDEN',
...
'var htmldb_ch_message=''"OK_TO_GET_NEXT_PREV_PK_VALUE"'';'
 ,p_required_role => 792306555881414154 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_cache_timeout_seconds => 21600
 ,p_cache_by_user_yn => 'N'
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 814645868659434452 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 29,
...
wwv_flow_api.create_report_region (
  p_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 29,
  p_name=> 'Items for Order #&P29_ORDER_ID.',
  p_region_name=>'',
  p_template=> 833780332213120840+ wwv_flow_api.g_id_offset,
  p_display_sequence=> 20,
  p_display_column=> 1,
  p_display_point=> 'BEFORE_SHOW_ITEMS',
  p_source=> s,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 814649264279434509 + wwv_flow_api.g_id_offset,
  p_region_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'CHECK$01',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 814648168338434498 + wwv_flow_api.g_id_offset,
  p_region_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 814648266891434498 + wwv_flow_api.g_id_offset,
  p_region_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 814648362737434499 + wwv_flow_api.g_id_offset,
  p_region_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
  ...
  p_hidden_column=> 'N',
  p_display_as=>'SELECT_LIST_FROM_LOV',
  p_named_lov=>815993577958214950 + wwv_flow_api.g_id_offset,
  p_lov_show_nulls=> 'NO',
  p_column_width=> '16',
  p_is_required=> false,
  p_pk_col_source=> s,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 814648470868434499 + wwv_flow_api.g_id_offset,
  p_region_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 814648554515434499 + wwv_flow_api.g_id_offset,
  p_region_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 816039972711724472 + wwv_flow_api.g_id_offset,
  p_region_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
wwv_flow_api.create_report_columns (
  p_id=> 669729479632171969 + wwv_flow_api.g_id_offset,
  p_region_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 834020541058050185 + wwv_flow_api.g_id_offset,
  p_region_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_button(
  p_id             => 946483291740885931 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 29,
  p_button_sequence=> 30,
  p_button_plug_id => 814645868659434452+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image   => 'template:'||to_char(833777645071120830+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Save Changes',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
...
wwv_flow_api.create_page_button(
  p_id             => 946486168875885983 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 29,
  p_button_sequence=> 40,
  p_button_plug_id => 814648049995434490+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 946484577480885951 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 29,
  p_button_sequence=> 50,
  p_button_plug_id => 814645868659434452+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 946484468898885951 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 29,
  p_button_sequence=> 60,
  p_button_plug_id => 814645868659434452+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 946483484507885932 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 29,
  p_button_sequence=> 10,
  p_button_plug_id => 814645868659434452+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 946483168074885931 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 29,
  p_button_sequence=> 40,
  p_button_plug_id => 814645868659434452+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 946483387698885931 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 29,
  p_button_sequence=> 20,
  p_button_plug_id => 814645868659434452+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 946486082474885983 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 29,
  p_button_sequence=> 20,
  p_button_plug_id => 814648049995434490+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>946485162714885967 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
  p_branch_action=> 'f?p=&APP_ID.:29:&SESSION.::&DEBUG.::P29_ORDER_ID:&P29_ORDER_ID_PREV.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>946484577480885951+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'Y',
  p_branch_comment=> 'This button is needed for Get Next or Previous Primary Key Value process.');
 
wwv_flow_api.create_page_branch(
  p_id=>946485085711885966 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
  p_branch_action=> 'f?p=&APP_ID.:29:&SESSION.::&DEBUG.::P29_ORDER_ID:&P29_ORDER_ID_NEXT.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>946484468898885951+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 20,
  p_save_state_before_branch_yn=>'Y',
  p_branch_comment=> 'This button is needed for Get Next or Previous Primary Key Value process.');
 
wwv_flow_api.create_page_branch(
  p_id=>948135968540119909 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
...
wwv_flow_api.create_page_branch(
  p_id=>946486789832885988 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
...
begin
wwv_flow_api.create_page_item(
  p_id=>814646353482434457 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
  p_name=>'P29_ORDER_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 99,
  p_item_plug_id => 814645868659434452+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Order Id',
  p_source=>'ORDER_ID',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>814646470211434465 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
...
begin
wwv_flow_api.create_page_item(
  p_id=>814646669143434468 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
  ...
  p_label_alignment=> 'RIGHT',
  p_field_alignment=> 'LEFT',
  p_field_template=> 833793555980120891+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_lov_display_extra=>'NO',
  p_escape_on_http_output => 'Y',
  p_attribute_01 => 'Y',
...
begin
wwv_flow_api.create_page_item(
  p_id=>814646757848434468 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
...
wwv_flow_api.create_page_item(
  p_id=>814646865925434469 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
  p_name=>'P29_USER_ID',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>814647468366434479 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
...
begin
wwv_flow_api.create_page_item(
  p_id=>814647563702434479 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
...
begin
wwv_flow_api.create_page_item(
  p_id=>814647654797434482 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
...
begin
wwv_flow_api.create_page_item(
  p_id=>816029354033681069 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 29,
...
wwv_flow_api.create_page_process(
  p_id     => 946484174971885948 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 29,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 946484966506885963 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 29,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 946484281765885951 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 29,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 946486277948885985 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 29,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 946486370486885985 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 29,
...
wwv_flow_api.create_page_process(
  p_id     => 946484385940885951 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 29,
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>946483387698885931 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 946486676603885988 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 29,
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to add rows',
  p_process_when_button_id=>946486168875885983 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 814656762124448813 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 1,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 814656878579448815 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 2,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 814656952451448815 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 3,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 814657052170448815 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 4,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 814657174745448815 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 5,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 816039866493724462 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 6,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 669729378790171968 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 7,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 834020456066050181 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 814648049995434490 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 8,
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 833773046349120814 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_cache_timeout_seconds => 21600
 ,p_cache_by_user_yn => 'N'
...
wwv_flow_api.create_page_plug (
  p_id=> 790918868999282172 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>790918968507282181 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 790918868999282172+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'User Name',
  p_source_type=> 'STATIC',
...
begin
wwv_flow_api.create_page_item(
  p_id=>790919171011282191 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>790919275212282191 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
...
wwv_flow_api.create_page_process(
  p_id     => 790919479787282197 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 790919364395282193 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 790919653126282199 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 790919575764282199 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'BEFORE_HEADER',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 834304346532461719 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 102,
...
wwv_flow_api.create_page_button(
  p_id             => 834307343101461756 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 102,
  p_button_sequence=> 20,
  p_button_plug_id => 834304346532461719+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_image   => 'template:'||to_char(833777440866120829+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Cancel',
  p_button_position=> 'REGION_TEMPLATE_CLOSE',
...
wwv_flow_api.create_page_button(
  p_id             => 834307148182461753 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 102,
  p_button_sequence=> 10,
  p_button_plug_id => 834304346532461719+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_item(
  p_id=>834304533294461735 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 834304346532461719+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> '',
...
wwv_flow_api.create_page_item(
  p_id=>834305053194461747 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
  p_name=>'P102_PAGE_ID',
  p_data_type=> '',
...
begin
wwv_flow_api.create_page_item(
  p_id=>834305535461461748 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
  p_name=>'P102_A',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>834305736859461748 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
...
begin
wwv_flow_api.create_page_item(
  p_id=>834306234228461749 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
  p_name=>'P102_X',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>834306426689461749 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
...
begin
wwv_flow_api.create_page_item(
  p_id=>834306925953461749 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
  p_name=>'P102_Y',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_process(
  p_id     => 834307530679461759 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 102,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>834307148182461753 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 834307752888461761 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 102,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_list (
  p_id=> 791290772805272506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Tasks',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
  p_display_row_template_id=> 833788955844120872 + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_list_item (
  p_id=> 816289078947637533 + wwv_flow_api.g_id_offset,
  p_list_id=> 791290772805272506 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_list_item (
  p_id=> 791291176961273686 + wwv_flow_api.g_id_offset,
  p_list_id=> 791290772805272506 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 791553761217082886 + wwv_flow_api.g_id_offset,
  p_list_id=> 791290772805272506 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list (
  p_id=> 791371570222385275 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_list_item (
  p_id=> 792518752912324611 + wwv_flow_api.g_id_offset,
  p_list_id=> 791371570222385275 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 791371973685386335 + wwv_flow_api.g_id_offset,
  p_list_id=> 791371570222385275 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list (
  p_id=> 808152074653869632 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Order Wizard',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
  p_display_row_template_id=> 833789545559120875 + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_list_item (
  p_id=> 808152480540871302 + wwv_flow_api.g_id_offset,
  p_list_id=> 808152074653869632 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>10,
...
wwv_flow_api.create_list_item (
  p_id=> 833850640424516452 + wwv_flow_api.g_id_offset,
  p_list_id=> 808152074653869632 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 808161853360901268 + wwv_flow_api.g_id_offset,
  p_list_id=> 808152074653869632 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 816056675822810416 + wwv_flow_api.g_id_offset,
  p_list_id=> 808152074653869632 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list (
  p_id=> 819412862991586279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Report Tabs',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
  p_display_row_template_id=> 833788623680120871 + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_list_item (
  p_id=> 819422960960614121 + wwv_flow_api.g_id_offset,
  p_list_id=> 819412862991586279 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>10,
...
wwv_flow_api.create_list_item (
  p_id=> 819422656804612890 + wwv_flow_api.g_id_offset,
  p_list_id=> 819412862991586279 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 819413770956588574 + wwv_flow_api.g_id_offset,
  p_list_id=> 819412862991586279 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 827923626966403080 + wwv_flow_api.g_id_offset,
  p_list_id=> 819412862991586279 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 834270153881959110 + wwv_flow_api.g_id_offset,
  p_list_id=> 819412862991586279 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 834277938785039883 + wwv_flow_api.g_id_offset,
  p_list_id=> 819412862991586279 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_menu (
  p_id=> 791178066478863823 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Main Menu');
 
wwv_flow_api.create_menu_option (
  p_id=>791181861760871935 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
wwv_flow_api.create_menu_option (
  p_id=>791237358775230581 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791181861760871935 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>791242178646245786 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791237358775230581 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>791369753945380658 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791181861760871935 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>791563561395120821 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791181861760871935 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>791563867628122651 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791563561395120821 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>791682049489457963 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791181861760871935 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Orders',
...
wwv_flow_api.create_menu_option (
  p_id=>792290248946336398 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791682049489457963 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>808146071227821305 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791682049489457963 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>808210667316037761 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791682049489457963 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Enter New Order',
...
wwv_flow_api.create_menu_option (
  p_id=>816232952591327126 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791682049489457963 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>819523159948840876 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791369753945380658 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>819525068259843330 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791181861760871935 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>819528061464850817 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791181861760871935 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Reports',
...
wwv_flow_api.create_menu_option (
  p_id=>819559462690964750 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791181861760871935 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Reports',
...
wwv_flow_api.create_menu_option (
  p_id=>827791127892937529 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791181861760871935 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Reports',
...
wwv_flow_api.create_menu_option (
  p_id=>833885145976889384 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791682049489457963 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Enter New Order',
...
wwv_flow_api.create_menu_option (
  p_id=>834259752511795614 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791181861760871935 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Reports',
...
wwv_flow_api.create_menu_option (
  p_id=>834267925823923901 + wwv_flow_api.g_id_offset,
  p_menu_id=>791178066478863823 + wwv_flow_api.g_id_offset,
  p_parent_id=>791181861760871935 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Reports',
...
prompt  ......Page template 833773046349120814
...
wwv_flow_api.create_template(
  p_id=> 833773046349120814 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 833774151418120819
...
wwv_flow_api.create_template(
  p_id=> 833774151418120819 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 833774434270120820
...
wwv_flow_api.create_template(
  p_id=> 833774434270120820 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 833774742384120820
...
wwv_flow_api.create_template(
  p_id=> 833774742384120820 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 833775033354120821
...
wwv_flow_api.create_template(
  p_id=> 833775033354120821 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 833775339987120822
...
wwv_flow_api.create_template(
  p_id=> 833775339987120822 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 833775627326120823
...
wwv_flow_api.create_template(
  p_id=> 833775627326120823 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 833775941310120824
...
wwv_flow_api.create_template(
  p_id=> 833775941310120824 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template 833777440866120829
declare
...
wwv_flow_api.create_button_templates (
  p_id=>833777440866120829 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 833777645071120830
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>833777645071120830 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 833777840839120830
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>833777840839120830 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......region template 833778228115120831
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833778228115120831 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833778543623120833
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833778543623120833 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833778827897120834
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833778827897120834 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833779128598120834
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833779128598120834 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 833779438729120836
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833779438729120836 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 833779732719120837
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833779732719120837 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833780052719120838
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833780052719120838 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 833780332213120840
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833780332213120840 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 833780629863120840
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833780629863120840 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833780924153120841
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833780924153120841 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833781244884120842
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833781244884120842 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833781550961120843
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833781550961120843 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833781838324120844
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833781838324120844 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-body">#BODY#</div>'||chr(10)||
...
prompt  ......region template 833782139909120845
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833782139909120845 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 833782430433120846
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833782430433120846 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833782754721120847
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833782754721120847 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833783041333120848
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833783041333120848 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 833783341964120849
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833783341964120849 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833783626194120850
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833783626194120850 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 833783956018120851
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833783956018120851 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833784233675120852
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833784233675120852 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="sidebar-region">'||chr(10)||
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
...
prompt  ......region template 833784525481120853
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833784525481120853 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="sidebar-region">'||chr(10)||
...
prompt  ......region template 833784841442120855
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833784841442120855 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833785052594120856
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833785052594120856 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 833785325294120857
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 833785325294120857 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-wizard" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......list template 833785624521120858
...
wwv_flow_api.create_list_template (
  p_id=>833785624521120858 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 833786540234120862
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>833786540234120862 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 833786825140120863
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>833786825140120863 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 833787443823120866
...
wwv_flow_api.create_list_template (
  p_id=>833787443823120866 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 833788324694120870
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>833788324694120870 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 833788623680120871
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>833788623680120871 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 833788955844120872
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>833788955844120872 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 833789545559120875
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>833789545559120875 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 833790349205120879
...
wwv_flow_api.create_row_template (
  p_id=> 833790349205120879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 833790830612120881
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 833790830612120881 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 833791339121120884
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 833791339121120884 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 833791853923120886
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 833791853923120886 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 833792342173120887
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 833792342173120887 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 833792845277120889
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 833792845277120889 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 833793136468120890
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 833793136468120890 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 833793451612120891
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 833793451612120891 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 833793555980120891
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 833793555980120891 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 833793647080120892
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 833793647080120892 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 833793847258120892
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 833793847258120892 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 833793924941120892
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 833793924941120892 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 833794750786120894
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 833794750786120894 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 833794141677120892
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 833794141677120892 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 833794843524120894
begin
wwv_flow_api.create_theme (
  p_id =>833794843524120894 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 4,
  ...
  p_login_template=>833773046349120814 + wwv_flow_api.g_id_offset,
  p_default_button_template=>833777440866120829 + wwv_flow_api.g_id_offset,
  p_default_region_template=>833783041333120848 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>833780052719120838 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>833780332213120840 + wwv_flow_api.g_id_offset,
  ...
  p_default_label_template=>833793647080120892 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>833793924941120892 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>833794141677120892 + wwv_flow_api.g_id_offset,
  p_default_list_template=>833788955844120872 + wwv_flow_api.g_id_offset,
  p_default_option_label=>833793647080120892 + wwv_flow_api.g_id_offset,
  p_default_required_label=>833793847258120892 + wwv_flow_api.g_id_offset);
end;
/
...
wwv_flow_api.create_shortcut (
 p_id=> 791244351529251244 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_shortcut (
 p_id=> 792272072884270594 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 792366459483850377
...
wwv_flow_api.create_auth_setup (
  p_id=> 792366459483850377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_plugin (
  p_id => 804381928894279531 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
wwv_flow_api.create_plugin_attribute (
  p_id => 804383534135309457 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 804381928894279531 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_plugin_attribute (
  p_id => 804384229764317598 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 804381928894279531 + wwv_flow_api.g_id_offset
 ,p_attribute_scope => 'COMPONENT'
...
wwv_flow_api.create_plugin_file (
  p_id => 804383049348292863 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 804381928894279531 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_install (
  p_id => 497508436008695137 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
